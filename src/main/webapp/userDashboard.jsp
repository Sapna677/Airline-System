...
<body>
    ...
    <nav>
        ...
        <ul>
            <li><a href="searchFlights.jsp"><i class="fas fa-search"></i> Search Flights</a></li>
            <li><a href="flightStatus.jsp"><i class="fas fa-signal"></i> Flight Status</a></li>
            <li><a href="logout.jsp"><i class="fas fa-sign-out-alt"></i> Logout</a></li>
        </ul>
    </nav>

    <div class="page-container">
        <div class="dashboard-card" style="margin-top: 60px;">
            <h1>Welcome to Your Dashboard</h1>
            <p class="info">Manage your bookings, view flight details, and explore more options with ease.</p>
            <div class="dashboard-actions">
                <a href="userProfile.jsp"><i class="fas fa-user-circle"></i> View Profile</a>
                <a href="userBookings.jsp"><i class="fas fa-ticket-alt"></i> Manage Bookings</a>
                <a href="searchFlights.jsp"><i class="fas fa-search-location"></i> Search Flights</a>
            </div>
        </div>
