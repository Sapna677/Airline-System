...
<body>
	...
	<div class="page-container" style="justify-content: center; align-items: center; min-height: 100vh; padding-top: 20px;">
		<div class="glass-card">
			<h1 class="signup-heading">Login Page</h1>
			<form action="loginAction.jsp" method="post">
				<label for="utype">Select Login For</label>
				<select name="utype" id="utype" required>
					<option value="" selected disabled>Select Login For...</option>
			...
			%>
			<p style="color: #f59e0b; margin-top: 15px; text-align: center; font-weight: 600;"><i class="fas fa-exclamation-triangle" style="margin-right: 5px;"></i> Please login to your account to book flights.</p>
			<%
			}
			%>
		</div>
